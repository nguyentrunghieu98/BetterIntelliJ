...
```
#### Step 2 : Download phpstorm 2021.1.1 or others (version / product like pycharm) [tested on phpstorm 2021.1.1] and Install the IDE

#### Step 3 : Run it as "Evaluate for free"

#### Step 4 : Install Plugin
  * Uninstall old cracks as plugin (if installed previous) 
  * Click "Configure" --> "Plugins" --> "Manage Plugin Responsitories"
  * Add https://repo.idechajian.com/ and ok
  * In "Marketplace" search "BetterIntelliJ" then install it
  * Restart IDE
  * OR (Edit Custom VM Options -> -javaagent:/{$HOME}/BetterIntelliJ-1.20.jar)
  
#### Step 5 : Click "Configure" --> "Manage License" --> "Add New License"--> "Activation Code" and enter following code;
